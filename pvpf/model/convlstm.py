...
class ConvLSTMBlock(keras.Model):
    def __init__(
        ...
        **kwargs,
        ...
        self._dropout_layer = keras.layers.Dropout(dropout)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._block_layers = [
            ConvLSTMBlock(
                **param,
                return_sequences=(idx != len(block_params) - 1),
                l2=l2,
                dropout=dropout,
            )
...
class ConvLSTMRegressor(keras.Model):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(*args, **kwargs)
        self._embedder = ConvLSTMImageEmbedder(block_params, l2, dropout)
...
class TwoImageRegressor(keras.Model):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(*args, **kwargs)
        self._lfm_embedder = ConvLSTMImageEmbedder(lfm_block_params, l2, dropout)
        self._jaxa_embedder = ConvLSTMImageEmbedder(jaxa_block_params, l2, dropout)
        self._dense = keras.layers.Dense(1)
